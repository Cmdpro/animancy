...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<SoulKeeper>> SOULKEEPER = ENTITY_TYPES.register("soulkeeper", () -> EntityType.Builder.of((EntityType.EntityFactory<SoulKeeper>) SoulKeeper::new, MobCategory.MONSTER).sized(1f, 2f).build(Spiritmancy.MOD_ID + ":" + "soulkeeper"));
}
