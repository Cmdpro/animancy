...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<SoulRitualController>> SOULRITUALCONTROLLER = ENTITY_TYPES.register("soulritualcontroller", () -> EntityType.Builder.of((EntityType.EntityFactory<SoulRitualController>) SoulRitualController::new, MobCategory.MONSTER).sized(0f, 0f).build(Spiritmancy.MOD_ID + ":" + "soulritualcontroller"));
}
