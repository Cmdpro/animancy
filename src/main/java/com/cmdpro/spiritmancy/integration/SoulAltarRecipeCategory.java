...
public class SoulAltarRecipeCategory implements IRecipeCategory<SoulAltarRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(Spiritmancy.MOD_ID, "soulaltar");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Spiritmancy.MOD_ID, "textures/gui/jei_soulaltar.png");
    ...
    public RecipeType<SoulAltarRecipe> getRecipeType() {
        return JEISpiritmancyPlugin.soulAltarCategory;
    }
