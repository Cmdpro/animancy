...
import com.cmdpro.spiritmancy.init.TagInit;
...
public class PatchouliMultiblocks {
    public static void register() {
        ...
        PatchouliAPI.get().registerMultiblock(new ResourceLocation(Spiritmancy.MOD_ID, "soulritual"), soulritual);
        PatchouliAPI.get().registerMultiblock(new ResourceLocation(Spiritmancy.MOD_ID, "soulritualnoflames"), soulritualnoflames);
    }
}
