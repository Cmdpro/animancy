...
public class BillboardProjectileRenderer extends EntityRenderer<BillboardProjectile> {
    ...
    public void render(BillboardProjectile proj, float p_114081_, float p_114082_, PoseStack stack, MultiBufferSource p_114084_, int p_114085_) {
        ...
        VertexConsumer vertexconsumer = p_114084_.getBuffer(RenderType.entityCutoutNoCull(getTextureLocation(proj)));
    ...
    private static void vertex(VertexConsumer p_114090_, Matrix4f p_114091_, Matrix3f p_114092_, int p_114093_, float p_114094_, int p_114095_, int p_114096_, int p_114097_) {
        p_114090_.vertex(p_114091_, p_114094_ - 0.5F, (float)p_114095_ - 0.5F, 0F).color(255, 255, 255, 255).uv((float)p_114096_, (float)p_114097_).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(p_114093_).normal(p_114092_, 0.0F, 1.0F, 0.0F).endVertex();
    }
