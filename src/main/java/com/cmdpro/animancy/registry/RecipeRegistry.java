...
public class RecipeRegistry {
    ...
    public static final RegistryObject<RecipeSerializer<ShapelessSoulAltarRecipe>> SHAPELESSSOULALTARRECIPE = RECIPES.register("shapeless_soul_altar_recipe", () -> ShapelessSoulAltarRecipe.Serializer.INSTANCE);
    public static final RegistryObject<RecipeSerializer<ShapedSoulAltarRecipe>> SHAPEDSOULALTARRECIPE = RECIPES.register("shaped_soul_altar_recipe", () -> ShapedSoulAltarRecipe.Serializer.INSTANCE);
    public static final RegistryObject<RecipeType<ISoulAltarRecipe>> SOULALTAR =
            RECIPE_TYPES.register("soulaltarrecipe", () -> RecipeType.simple(new ResourceLocation(Animancy.MOD_ID, "soul_altar_recipe")));
