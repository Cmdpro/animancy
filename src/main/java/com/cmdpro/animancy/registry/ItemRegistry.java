...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> SOULALTARITEM = register("soulaltar", () -> new SoulAltarItem(BlockRegistry.SOULALTAR.get(), new Item.Properties()));
    public static final RegistryObject<Item> SOULCRYSTAL = register("soulcrystal", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CRYSTALSOULSMUSICDISC = register("crystalsoulsmusicdisc", () -> new RecordItem(6, SoundRegistry.CRYSTALSOULS, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 2220));
    public static final RegistryObject<Item> THESOULSSCREAMMUSICDISC = register("thesoulsscreammusicdisc", () -> new RecordItem(6, SoundRegistry.SOULKEEPERPHASE1, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 1860));
    public static final RegistryObject<Item> THESOULSREVENGEMUSICDISC = register("thesoulsrevengemusicdisc", () -> new RecordItem(6, SoundRegistry.SOULKEEPERPHASE2, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 1500));
