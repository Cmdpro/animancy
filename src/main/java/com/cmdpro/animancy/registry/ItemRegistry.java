...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> SOULMETALDAGGER = register("soulmetal_dagger", () -> new SwordItem(ModTiers.SCYTHE, 1, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PURGATORYDAGGER = register("purgatory_dagger", () -> new SwordItem(ModTiers.PURGATORY, 1, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PURGATORYSWORD = register("purgatory_sword", () -> new PurgatorySword(ModTiers.PURGATORY, 5, -2.4F, new Item.Properties()));
    ...
    public static final RegistryObject<Item> PURGATORYINGOT  = register("purgatory_ingot", () -> new Item(new Item.Properties()));
