...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<SpiritArrow>> SPIRIT_ARROW = ENTITY_TYPES.register("spirit_arrow", () -> EntityType.Builder.of((EntityType.EntityFactory<SpiritArrow>) SpiritArrow::new, MobCategory.MISC).sized(0.5F, 0.5F).build(Animancy.MOD_ID + ":" + "spirit_arrow"));
}
